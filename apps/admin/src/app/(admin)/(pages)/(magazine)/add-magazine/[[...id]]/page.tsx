import AddMagazineForm from "./add-magazine";

 


export const metadata = {
  title: "Add Magazine | Admin Panel",
  description: "Create new user with roles, credentials, and profile details.",
  keywords: ["Next.js", "Magazine Management", "Admin Panel", "React Form"],
  authors: [{ name: "Suraj" }],
  openGraph: {
    title: "Add Magazine",
